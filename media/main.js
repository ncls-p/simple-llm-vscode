(() => {
  ...
  elements.chatContainer.addEventListener(
    "mousedown",
    handleChatContainerMouseDown
  );
  document.addEventListener("mousemove", handleDocumentMouseMove);
  document.addEventListener("mouseup", handleDocumentMouseUp);
  elements.conversationSelect.addEventListener(
    "change",
    handleConversationChange
  );
  elements.deleteConversationButton.addEventListener(
    "click",
  ...
  function handleDocumentMouseMove(e) {
    ...
    elements.chatContainer.style.height = `${
      elements.chatContainer.clientHeight + delta
    }px`;
    state.lastY = e.clientY;
  }
  ...
  function updateConversations(conversations) {
    ...
    if (
      previousSelectedConversation !== "new" &&
      conversations.some((c) => c.id === previousSelectedConversation)
    ) {
